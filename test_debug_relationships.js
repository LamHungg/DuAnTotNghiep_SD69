// Script để test endpoint với debug relationships
// Chạy script này trong browser console sau khi backend restart

const testDebugRelationships = async () => {
  try {
    console.log("Testing endpoint with debug relationships...");
    ...
    // Test 2: Lấy chi tiết sản phẩm ID 6 (có ảnh)
    console.log("2. Testing GET /api/chi-tiet-san-pham/6");
