      ...
      <div className="footer__container">
        <div className="footer__col footer__col--social">
          <div className="footer__brand">
            THEZMEN.VN từ các nền tảng khác nhau nhé!
          </div>
          <div className="footer__socials">
            <a href="#" className="footer__icon" aria-label="Facebook">
              <span role="img" aria-label="fb">
                📘
              </span>
            </a>
            <a href="#" className="footer__icon" aria-label="Instagram">
              <span role="img" aria-label="ig">
                📸
              </span>
            </a>
            <a href="#" className="footer__icon" aria-label="TikTok">
              <span role="img" aria-label="tt">
                🎵
              </span>
            </a>
            <a href="#" className="footer__icon" aria-label="Shopee">
              <span role="img" aria-label="sp">
                🛒
              </span>
            </a>
            <a href="#" className="footer__icon" aria-label="Lazada">
              <span role="img" aria-label="lz">
                📦
              </span>
            </a>
          </div>
        ...
        <div className="footer__container">
          <div className="footer__bottom-content">
            <div className="footer__copyright">
              2024 THEZMEN.VN. Tất cả quyền được bảo lưu.
            </div>
