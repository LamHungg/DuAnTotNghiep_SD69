-- Script kiểm tra và tạo bảng giỏ hàng
USE [ZMEN_DB]; -- Thay đổi tên database nếu cần
...
-- Kiểm tra chi tiết sản phẩm có sẵn
SELECT TOP 5 id, gia, so_luong FROM chi_tiet_san_pham;
