...
const testAdminOrders = async () => {
  try {
    ...
    console.log("=== ADMIN ORDERS TEST COMPLETED ===");
  } catch (error) {
...
// Export function
window.testAdminOrders = testAdminOrders;
